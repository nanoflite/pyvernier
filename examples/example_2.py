...
config = {
            'filename': 'example_2.pdf',        # Name of the file
            'main_scale_size': 85,              # Size of the main scale in mm
            'vernier_size': 2,                  # Width between two ticks on the vernier scale
            'vernier_resolution': 0.1,          # Resolution for the vernier scale (0.1 or 0.05 are sane values) 
            'major_tick_size': 4,               # Major tick size for the main scale
            'minor_tick_size': 2,               # Minor tick size for the main scale
            ...
            'text_margin': 0.2,                 # Margin around the text
            'text_size': 1.5,                     # Size of the text
