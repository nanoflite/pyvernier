...
config = {
            'filename': 'example_4.pdf',        # Name of the file
            'main_scale_size': 50,              # Size of the main scale in mm
            'vernier_size': 4,                  # Width between two ticks on the vernier scale
            ...
            'vernier_major_tick_size': 4,       # Major tick size for the vernier scale
            'vernier_minor_tick_size': 2,       # Minor tick size for the vernier scale
            ...
            'color': '(1.0, 1.0, 1.0)',         # Color of the lines
